...
import { useOccurrenceFormOptions } from "@/app/transfer/hooks/use-occurrence-form-options";
import { useVehicleFormOptions } from "@/app/transfer/hooks/use-vehicle-form-options";
import type {
	FileValue,
	OccurrenceData,
	OccurrenceForm,
	OccurrencePayload,
} from "@/app/transfer/types/types-occurrence";
import type { ImageValue } from "@/app/transfer/types/types-vehicle";
import {
	OccurrenceFormSchema,
	OccurrencePayloadSchema,
} from "@/app/transfer/validation/validation-occurrence";
